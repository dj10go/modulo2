...
atualiza_fun () {
wget wget https://raw.githubusercontent.com/AAAAAEXQOSyIpN2JZ0ehUQ/PROYECTOS_DESCONTINUADOS/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/VPS-MX &> /dev/null; chmod 777 VPS-MX* && ./VPS-MX*
msg -bar2
}
funcao_idioma () {
tput cuu1 && tput dl1
